  ...
  getCovidVaccinationData = async () => {
    ...
    if (response.ok === true) {
      ...
      const updatedData = {
        ...
        vaccinationByAgeData: fetchData.vaccination_by_age.map(range => ({
          age: range.age,
          count: range.count,
        })),
        vaccinationByGenderData: fetchData.vaccination_by_gender.map(
          genderType => ({
    ...
    return (
      <div className="bg-container">
        <div className="cowinContainer">
          ...
          <h1 className="page_heading">CoWIN Vaccination in India</h1>
